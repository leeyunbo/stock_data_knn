...
def get_cv_maN_rate(N,data):
    maN_value = get_cv_maN_value(5,data)
    maN_rate = list()
...
stock_read_data = stock_read_data[["basic_date", "stockname", "close_value"]]
...
add_stock_read_data['ud_3d'] = get_un_Nd(stock_read_data)
print(add_stock_read_data)

add_stock_read_data.to_csv("stock_history.added2.csv", encoding="ms949")
